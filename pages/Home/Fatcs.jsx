    ...
    <div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.2s">
      <div className="d-flex">
        ...
        <div className="ps-4">
          ...
          <h1 className="display-5 text-secondary mb-0" data-toggle="counter-up">1.000.000</h1>
        </div>
      </div>
    </div>
    <div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.3s">
      <div className="d-flex">
        ...
        <div className="ps-4">
          ...
          <h1 className="display-5 text-secondary mb-0" data-toggle="counter-up">250</h1>
        </div>
      </div>
    </div>
    <div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.4s">
      <div className="d-flex">
        ...
        <div className="ps-4">
          ...
          <h1 className="display-5 text-secondary mb-0" data-toggle="counter-up">20.000</h1>
        </div>
      </div>
    </div>
  </div>
